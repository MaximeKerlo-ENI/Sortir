...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Participants::class, mappedBy="userNoUser", cascade={"persist", "remove"})
     */
    ...
    public function setParticipants(Participants $participants): self
    {
        ...
        if ($participants->getUserNoUser() !== $this) {
            $participants->setUserNoUser($this);
        }
    ...
    {
        // set the owning side of the relation if necessary
        if ($participantId->getUserNoUser() !== $this) {
            $participantId->setUserNoUser($this);
        }
